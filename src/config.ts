...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/a01084812159-oss", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://github.com/a01084812159-oss",
		},
		{
			name: "Dreamhack",
